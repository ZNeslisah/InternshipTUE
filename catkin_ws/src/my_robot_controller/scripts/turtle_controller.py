#Combine Publisher and Subscriber in a Closed Loop System & Write a ROS Service Client
...
def pose_callback(pose: Pose):
    cmd =Twist()
    #turtle will slow down and turn when it is near the wall
    ...
    #the color of turtle way will change when it enter to other half of the screen
    global previous_x
